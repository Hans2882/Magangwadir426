...
@section('content-header')
    <div class="row mb-2">
        <div class="col-sm-6"><h1 class="m-0">Data IA</h1></div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item active">Data IA</li>
            </ol>
        </div>
    </div>
@endsection
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="dm-badge-card dm-badge-blue">
            <div class="dm-badge-icon"><i class="bi bi-file-earmark-check"></i></div>
            <div class="dm-badge-body">
                <div class="dm-badge-num" id="totalDalamNegeri">—</div>
                <div class="dm-badge-label">IA Dalam Negeri</div>
            </div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="dm-badge-card dm-badge-teal">
            ...
            <div class="dm-badge-body">
                ...
                <div class="dm-badge-label">IA Luar Negeri</div>
            </div>
        </div>
    </div>
</div>
...
<div class="card card-outline card-primary shadow-sm">
    <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="iaTabs" role="tablist">
                ...
                <div class="dm-controls">
                    ...
                    <div class="dm-controls-right">
                        <div class="dm-search-wrap">
                            ...
                            <input type="text" id="dnSearch" class="dm-search-input" placeholder="Cari IA...">
            ...
            <div class="tab-pane fade" id="tab-ln" role="tabpanel">
                <div class="dm-controls">
                    ...
                    <div class="dm-controls-right">
                        <div class="dm-search-wrap">
                            <i class="bi bi-search dm-search-icon"></i>
                            <input type="text" id="lnSearch" class="dm-search-input" placeholder="Cari IA...">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background:#113261;color:#fff;">
                <h5 class="modal-title" id="detailModalLabel">
                    <i class="bi bi-file-earmark-check-fill me-2"></i><span id="modalTitle"></span>
                </h5>
...
$(function () {
    ...
    function wire(tbl, searchId, resetId, lengthId, infoId, pagId, wrapId) {
        ...
        tbl.on('draw',function(){
            ...
            $(infoId).text(txt); $(pagId).html('').append($(wrapId+' .dataTables_paginate').clone(true,true));
        });
    }
    ...
    var tableDN = $('#tableDalamNegeri').DataTable({
        ...
        ajax:{ url:'{{ route("data-kerjasama.ajax.ia-dalam-negeri") }}', type:'GET' },
        columns:[
    ...
    $('#tab-ln-btn').one('shown.bs.tab',function(){
        tableLN = $('#tableLuarNegeri').DataTable({
            processing:true, serverSide:true,
            ajax:{ url:'{{ route("data-kerjasama.ajax.ia-luar-negeri") }}', type:'GET' },
            columns:[
                {data:'no',orderable:false,searchable:false,className:'text-center'},
