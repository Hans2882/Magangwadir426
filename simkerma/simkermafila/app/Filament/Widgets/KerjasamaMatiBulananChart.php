...
{
    protected ?string $heading = 'Jumlah Kerjasama Mati per Bulan';

    protected ?string $description = 'MoU, PKS, dan IA yang berakhir per bulan (termasuk proyeksi 1 tahun ke depan untuk MoU)';
